...
alias rpc-reboot="sudo bash /rpicluster/config/reboot.sh"
alias rpc-shutdown="sudo bash /rpicluster/config/shutdown.sh"
alias rpc-install="f(){ sudo bash /rpicluster/config/install.sh "$1"; unset -f f; }; f"
